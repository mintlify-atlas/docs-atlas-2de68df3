...
<CardGroup cols={2}>
  <Card title="Speech-to-Text" icon="microphone" href="/api/stt">
    Transcribe audio files or live microphone input with multiple model types
  </Card>
  <Card title="Text-to-Speech" icon="volume-high" href="/api/tts">
    Generate natural speech from text with multi-language and multi-speaker support
  </Card>
  <Card title="Streaming Recognition" icon="waveform" href="/api/streaming-stt">
    Real-time speech recognition with partial results and endpoint detection
  </Card>
  <Card title="Streaming TTS" icon="tower-broadcast" href="/api/streaming-tts">
